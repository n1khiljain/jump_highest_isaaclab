...
All the environments are registered in the `Jump_Highest` extension. They start
...
import Jump_Highest.tasks  # noqa: F401


def main():
    """Print all environments registered in `Jump_Highest` extension."""
